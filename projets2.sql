...
(1, 'Said', 542247381, 1, 1),
(3, 'Ali', 54653, NULL, NULL);
...
CREATE TABLE `client` (
  ...
  `partRevenu` decimal(12,2) DEFAULT '0.00',
...
(1, 'messaoud', 'entreprise', '0.00', 0, '12345678', 'fk_boutiba@esi.dz', 'chambre L70', NULL, NULL),
(2, 'karim', 'individuel', '0.00', 0, '12345678', 'fk_boutiba@esi.dz', 'chambre L70', NULL, NULL),
(3, 'nassim', 'individuel', '0.00', 0, '12345678', 'fk_boutiba@esi.dz', 'chambre L70', NULL, NULL),
(4, 'omar', 'individuel', '0.00', 0, '12345678', 'fk_boutiba@esi.dz', 'chambre L70', NULL, NULL),
(5, 'oussama', 'entreprise', '0.00', 0, '12345678', 'fk_bougga@esi.dz', 'chambre L70', NULL, NULL),
(7, 'chbiyeb', 'individuel', '0.00', 0, '6864343', 'fk_bouti@esi.dz', 'chambre L72', NULL, NULL),
(8, 'bouelouf', 'individuel', '0.00', 0, '54654000', 'fk_boutiba@enp.dz', 'chambre L73', NULL, NULL),
(11, 'chbiyeb', 'individuel', '0.00', 0, '6864343', 'fk_bouti@esi.dz', 'chambre L72', NULL, NULL),
(12, 'bouelouf', 'individuel', '0.00', 0, '54654000', 'fk_boutiba@enp.dz', 'chambre L73', NULL, NULL),
(15, 'chbiyeb', 'individuel', '0.00', 0, '6864343', 'fk_bouti@esi.dz', 'chambre L72', NULL, NULL),
(16, 'bouelouf', 'individuel', '0.00', 0, '54654000', 'fk_boutiba@enp.dz', 'chambre L73', NULL, NULL);
...
('0', NULL, NULL, NULL, NULL, NULL, NULL, '1', 0, 2),
('1', NULL, NULL, NULL, NULL, NULL, NULL, '0', 0, 3),
('2', NULL, NULL, NULL, NULL, NULL, NULL, '1', 0, 4),
('3', NULL, NULL, NULL, NULL, NULL, NULL, '1', 0, 1),
('32', NULL, NULL, NULL, NULL, NULL, NULL, '0', 0, 3),
('4', NULL, NULL, NULL, NULL, NULL, NULL, '1', 0, 1),
('44', NULL, NULL, NULL, NULL, NULL, NULL, '1', 0, 4),
('55', NULL, NULL, NULL, NULL, NULL, NULL, '1', 0, 1),
('66', NULL, NULL, NULL, NULL, NULL, NULL, '1', 0, 1),
('77', NULL, NULL, NULL, NULL, NULL, NULL, '1', 0, 2),
('JKGFD5619', 13, 516, 40, 'VOITURE', 'Said', 211651, '0', 0, 1);
...
--
-- Table structure for table `douane`
--
...
--
-- Table structure for table `prixunitaires`
--
...
--
ALTER TABLE `dossier`
  MODIFY `idDossier` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;
--
-- AUTO_INCREMENT for table `douane`
--
ALTER TABLE `douane`
...
--
ALTER TABLE `conteneur`
  ADD CONSTRAINT `idDossier` FOREIGN KEY (`idDossier`) REFERENCES `dossier` (`idDossier`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Constraints for table `ctfact`
--
ALTER TABLE `ctfact`
  ADD CONSTRAINT `idFact` FOREIGN KEY (`idFacture`) REFERENCES `facture` (`idFacture`),
